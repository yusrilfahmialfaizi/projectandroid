...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction textView = onView(
                allOf(withId(R.id.word), withText("Word 13"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Word 13")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.word), withText("Word 13"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("Word 13")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.word), withText("Word 13"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView3.check(matches(withText("Word 13")));
